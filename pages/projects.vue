<template>
  <div class="projects">
    <div class="projects__project">
      <div v-if="isProjectsRoot" class="work">
        <ProjectFilter />
    ...
    <nuxt-link
      v-if="!isProjectsRoot"
      :to="nextProject.link"
      class="next-project next-project__next alt-focus"
    >
...
export default {
  ...
  computed: {
    ...
    project() {
      return this.$store.state.content.projects.find(
    ...
    nextProject() {
      ...
      if (lastProject) {
        ...
        let nextProject = this.$store.state.content.projects.find(
          (p) => p.fields.id == currentId + 1
        );
